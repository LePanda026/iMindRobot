...
embedding_model_dict = {
    "m3e-base": "./checkpoint/embedding_checkpoint/m3e",
...
PROMPT_TEMPLATE = """<指令>根据已知信息来回答问题。如果无法从中得到答案，请告知用户”已知信息无法做出回复”，并根据自身能力做出回复，答案请使用中文。 </指令>
...
tts_model_dict = {
    "bertvits2": {
        "config_file": "./TTS/configs/tts_config.json",
        "model_file": r"./checkpoint/tts/character/yunjin.pth",
    },
